...
def ab_grading_consensus():
    output_path = base_path + 'Bleeding-Grading_Consensus_0412_test/'
    if not os.path.exists(output_path):
        os.makedirs(output_path)
    
    for root, dirs, files in os.walk(base_path + 'Individual_to_Consensus_0412'):
        ...
        for patients in patients_list:
            ...
            for i in channel: #['ch1', 'ch3', 'ch5']
                ...
                for i, row_value in enumerate(ws1_all_value):
                    ...
                    tmp_row_value2 = row_value[:9]
                    row_value1 = modified_list(tmp_row_value1)
                    row_value2 = modified_list(tmp_row_value2)
            ...
            del write_wb['Sheet']
            # write_wb.save(filename = filename)
